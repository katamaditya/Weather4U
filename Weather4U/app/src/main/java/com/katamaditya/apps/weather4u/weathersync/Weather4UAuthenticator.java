...
/**
 * Manages "Authentication" to Weather4U's backend service.  The SyncAdapter framework
 ...
 */
public class Weather4UAuthenticator extends AbstractAccountAuthenticator {

    public Weather4UAuthenticator(Context context) {
        super(context);
    }
